...
export async function generateStaticParams() {
  // Retorna os IDs dos pacientes que devem ser pré-gerados durante a build
  // Por enquanto, retornando um array vazio para permitir ISR ou fallback
  return []
}
      ...
      <Tabs defaultValue="assessment" className="space-y-6">
        ...
        <TabsContent value="timeline" className="animate-slide-up">
          <Card className="border-none shadow-sm">
            ...
            <CardContent>
              <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-g[...]
                {[
                  ...
                  <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-primary text-slate-500 group-[.is-active]:text-w[...]
